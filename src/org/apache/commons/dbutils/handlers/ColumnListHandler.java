...
import com.lizard.fastdb.jdbc.JdbcUtil;

/**
 * <code>ResultSetHandler</code> implementation that converts one <code>ResultSet</code> column into a <code>List</code> of <code>Object</code>s.
...
public class ColumnListHandler extends AbstractListHandler<Object>
{
	...
	{
		/*
		 * if (this.columnName == null) { obj = rs.getObject(this.columnIndex); } else { obj = rs.getObject(this.columnName); }
		 */

		// SHEN.GANG 增加是否为浮点数判断
		// 判断数值精度，看是否是浮点数
		Object obj = null;
